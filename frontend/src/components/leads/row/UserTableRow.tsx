...
const TableRow: React.FC<TableRowProps> = ({
  ...
  return (
    <tr className="bg-white ">
        ...
        userData.roles.some(
          ...
          <td className="hidden px-4 py-4 lg:table-cell whitespace-nowrap">
            <div className="flex items-center space-x-4">
              ...
              <Button
                variant="ghost"
                className="inline-flex gap-2 items-center px-3 py-2 text-sm font-medium text-gray-700 transition-all duration-200 bg-white border border-gray-300 rounded-md shadow-sm"
                onClick={async () => {
                  try {
      ...
      {isSelected && (
        <div className="absolute bottom-0 left-0 w-[95%] mx- rounded-xl  bg-slate-100  stroke-gray-300 border">
