...
export class TransactionTaskController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The transactionTask has been successfully created.',
  })
  @UseInterceptors(
  ...
  async create(
    ...
    createTransactionTasksDtoSeperated.transactionId = Number(
      createTransactionTasksDto.transactionId,
    );

    return await this.transactionTasksService.create(
      createTransactionTasksDtoSeperated,
    );
  }
  ...
  @ApiParam({
    name: 'id',
    required: true,
    description: 'The id of the transactionTask to update',
  })
  @ApiBody({ type: UpdateTransactionTaskDto })
  @ApiResponse({
    status: 200,
    description: 'The transactionTask has been successfully updated.',
  })
  async update(
    @Param('id') id: number,
  ...
  @ApiParam({
    name: 'id',
    required: true,
    description: 'The id of the transactionTask to delete',
  })
  @ApiResponse({
    status: 200,
    description: 'The transactionTask has been successfully deleted.',
  })
  ...
  @ApiParam({
    name: 'id',
    required: true,
    description: 'The id of the transactionTask',
  })
